<div class="container">
	<div class="blog-header">
		<h1 class="blog-title">Impressum / Kontakt</h1>
		<p class="lead blog-description">Bei Fragen, oder Anregungen... schreib mir!</p>
	</div>
	<div class="row">
        <div class="col-sm-8 blog-main">
			<div class="blog-post">
				<h2 class="blog-post-title">Persönlicher Kontakt</h2>
				<p>Angaben gemäß § 5 TMG:</p>
				<p>Marc Schieferdecker<br/>Lendringser Hauptstraße 21a</p>
				<p>58710 Menden (Sauerland)</p>
				<p><span class="glyphicon glyphicon-earphone"></span> (0176) 321 30 654</p>
				<p><span class="glyphicon glyphicon-envelope"></span> <a href="mailto:m_schieferdecker@hotmail.com">m_schieferdecker@hotmail.com</a></p>
				<p class="alert alert-info">Hinweis: Bei Fehlern in Fragen, bitte unbedingt die Nummer der Frage mit angeben!</p>
			</div>
			<div class="blog-post">
				<h2 class="blog-post-title">Haftungsausschluss</h2>
